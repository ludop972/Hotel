...
{
    #[Route('/reservations', name: 'app_booking_index', methods: ['GET'])]
    ...
    #[Route('/reservation/new', name: 'app_booking_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/reservation/{id}', name: 'app_booking_show', methods: ['GET'])]
    ...
    #[Route('/reservation/{id}/edit', name: 'app_booking_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/reservation/{id}', name: 'app_booking_delete', methods: ['POST'])]
